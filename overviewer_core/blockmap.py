...
for i in range(len(colors)):
    blockmap['minecraft:%s_stained_glass'      % colors[i]] = (95, i)
    blockmap['minecraft:%s_stained_glass_pane' % colors[i]] = (160, i)
    blockmap['minecraft:%s_banner'             % colors[i]] = (176, i) #not rendering
    blockmap['minecraft:%s_wall_banner'        % colors[i]] = (177, i) #not rendering
    blockmap['minecraft:%s_concrete'           % colors[i]] = (251, i)
